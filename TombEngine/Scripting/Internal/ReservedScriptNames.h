...
static constexpr char ScriptReserved_GetExposure[]				= "GetExposure";
static constexpr char ScriptReserved_SetExposure[]				= "SetExposure";
...
static constexpr char ScriptReserved_GetHolsterWeaponTypes[]	= "GetHolsterWeaponTypes";
static constexpr char ScriptReserved_SetHolsterWeaponTypes[]	= "SetHolsterWeaponTypes";
static constexpr char ScriptReserved_ResetHair[]				= "ResetHair";
static constexpr char ScriptReserved_SpawnGunFlash[]			= "SpawnGunFlash";
static constexpr char ScriptReserved_ClearGunFlashes[]			= "ClearGunFlashes";
...
static constexpr char ScriptReserved_GetJointOffset[]			= "GetJointOffset";
static constexpr char ScriptReserved_SetJointOffset[]			= "SetJointOffset";
static constexpr char ScriptReserved_GetJointScale[]			= "GetJointScale";
static constexpr char ScriptReserved_SetJointScale[]			= "SetJointScale";
static constexpr char ScriptReserved_GetAdditionalJointRotation[]	= "GetAdditionalJointRotation";
static constexpr char ScriptReserved_SetAdditionalJointRotation[]	= "SetAdditionalJointRotation";
...
static constexpr char ScriptReserved_GetSkinnedMesh[]			= "GetSkinnedMesh";
...
static constexpr char ScriptReserved_ParticleGroupPause[]					= "Pause";
static constexpr char ScriptReserved_ParticleGroupResume[]					= "Resume";
static constexpr char ScriptReserved_ParticleGroupEmitBurst[]				= "EmitBurst";
static constexpr char ScriptReserved_ParticleGroupGetActiveCount[]			= "GetActiveCount";
static constexpr char ScriptReserved_ParticleGroupSetEmissionRate[]			= "SetEmissionRate";
static constexpr char ScriptReserved_ParticleGroupSetPosition[]				= "SetPosition";
static constexpr char ScriptReserved_ParticleGroupGetPosition[]				= "GetPosition";
static constexpr char ScriptReserved_ParticleGroupSetInitialVelocity[]		= "SetInitialVelocity";
static constexpr char ScriptReserved_ParticleGroupSetVelocityRandom[]		= "SetInitialVelocityRandom";
static constexpr char ScriptReserved_ParticleGroupSetInitialAcceleration[]	= "SetInitialAcceleration";
static constexpr char ScriptReserved_ParticleGroupSetLifetime[]				= "SetLifetime";
static constexpr char ScriptReserved_ParticleGroupSetLifetimeRange[]		= "SetLifetimeRange";
static constexpr char ScriptReserved_ParticleGroupSetInitialSize[]			= "SetInitialSize";
static constexpr char ScriptReserved_ParticleGroupSetInitialSizeRange[]		= "SetInitialSizeRange";
static constexpr char ScriptReserved_ParticleGroupSetInitialColor[]			= "SetInitialColor";
static constexpr char ScriptReserved_ParticleGroupSetInitialColorRange[]	= "SetInitialColorRange";
static constexpr char ScriptReserved_ParticleGroupSetInitialRotation[]		= "SetInitialRotation";
static constexpr char ScriptReserved_ParticleGroupSetInitialRotVel[]		= "SetInitialRotationVelocity";
static constexpr char ScriptReserved_ParticleGroupSetBlendMode[]			= "SetBlendMode";
static constexpr char ScriptReserved_ParticleGroupSetObjectID[]				= "SetObjectID";
static constexpr char ScriptReserved_ParticleGroupSetSubIndex[]				= "SetSubIndex";
static constexpr char ScriptReserved_ParticleGroupGetSubIndex[]				= "GetSubIndex";
static constexpr char ScriptReserved_ParticleGroupGetObjectID[]				= "GetObjectID";
static constexpr char ScriptReserved_ParticleGroupIsMeshGroup[]				= "IsMeshGroup";
static constexpr char ScriptReserved_ParticleGroupSetInitialOrientation[]	= "SetInitialOrientation";
...
static constexpr char ScriptReserved_AudioChannel[]				= "AudioChannel";
static constexpr char ScriptReserved_AudioChannelPlay[]			= "Play";
static constexpr char ScriptReserved_AudioChannelStop[]			= "Stop";
static constexpr char ScriptReserved_AudioChannelPause[]		= "Pause";
static constexpr char ScriptReserved_AudioChannelResume[]		= "Resume";
static constexpr char ScriptReserved_AudioChannelClear[]		= "Clear";
static constexpr char ScriptReserved_AudioChannelSetTrack[]		= "SetTrack";
static constexpr char ScriptReserved_AudioChannelIsPlaying[]	= "IsPlaying";
static constexpr char ScriptReserved_AudioChannelGetTrack[]		= "GetTrack";
static constexpr char ScriptReserved_AudioChannelGetLoudness[]	= "GetLoudness";
static constexpr char ScriptReserved_AudioChannelSetVolume[]	= "SetVolume";
static constexpr char ScriptReserved_AudioChannelGetVolume[]	= "GetVolume";
static constexpr char ScriptReserved_AudioChannelShuffleStart[]	= "SetShuffleStart";
static constexpr char ScriptReserved_AudioChannelSetDampBGM[]	= "SetDampBGM";
static constexpr char ScriptReserved_AudioChannelGetDampBGM[]	= "GetDampBGM";
...
static constexpr char ScriptReserved_AudioChannelGetType[]		= "GetType";
static constexpr char ScriptReserved_AudioChannelSetType[]		= "SetType";
static constexpr char ScriptReserved_AudioChannelSetCrossFadeLength[] = "SetCrossFadeLength";
