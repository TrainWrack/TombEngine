...
enum LaraState
{
	...
	LS_CRAWL_VAULT_JUMP_FLIP = 155,
	LS_SLOPE_CLIMB_HANG = 156,
	LS_SLOPE_CLIMB_SHIMMY = 157,
	LS_SLOPE_CLIMB_START = 158,
	LS_SLOPE_CLIMB_STOP = 159,
	LS_SLOPE_CLIMB_END = 160,
	LS_CRAWL_VAULT_1_STEP_UP = 161,
	LS_CRAWL_VAULT_1_STEP_DOWN = 162,
	LS_MONKEY_BACK = 163,
	LS_STAND_VAULT = 164,
	LS_STAND_VAULT_2_STEPS_UP = 165,
	LS_STAND_VAULT_3_STEPS_UP = 166,
	LS_STAND_VAULT_1_STEP_UP_TO_CROUCH = 167,
	LS_STAND_VAULT_2_STEPS_UP_TO_CROUCH = 168,
	LS_STAND_VAULT_3_STEPS_UP_TO_CROUCH = 169,
	LS_SOFT_SPLAT = 170,
